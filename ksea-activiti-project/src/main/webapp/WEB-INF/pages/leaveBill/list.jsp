 	...
 	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
		        <td height="20" bgcolor="#FFFFFF" class="STYLE10" colspan="8"><div align="left">
					<a href="${pageContext.request.contextPath }/leavebillAction_addUI.action">添加请假申请</a>
				</div></td>
		  </tr> 
		  <tr>
		      ...
		      <s:if test="#list!=null && #list.size()>0">
		      	 <s:iterator value="#list">
		      	 	<tr>
				        ...
				        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><s:property value="applicator"/></div></td>
